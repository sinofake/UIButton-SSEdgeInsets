#
#  Be sure to run `pod spec lint UIButton-SSEdgeInsets.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Sinofake Sinep"
  # s.authors            = { "Sinofake Sinep" => "sinuofake@gmail.com" }
